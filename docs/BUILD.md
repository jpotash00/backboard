# Build status, layout & how to run

The status, repository structure, and all the runnable commands live here so the
[README](../README.md) can stay a product overview.
